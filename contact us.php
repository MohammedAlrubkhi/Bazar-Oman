...
<body>
    ...
    <div class="container">
        <header class="d-flex flex-wrap  justify-content-center justify-content-md-between py-3 mb-4">
          ...
          <a href="search.php"><button type="button" class="btn btn-outline-primary normal-button" style = "color: black; "><img src = "search-white.png" alt = "search button" height = "20px"></button></a>
